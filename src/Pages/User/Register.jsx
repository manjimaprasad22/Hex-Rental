...
const validateconfirmPassword=(e)=>{
  ...
  const validateForm =async (e) => {
    ...
    if (Password !== cnfpassword) {
      ...
      await axios({
        url:`${REACT_APP_SERVER_URL}/api/customer/create?`,
        method:'POST',
        data:{
          cust_fname:fname,
          cust_lname:lname,
  ...
  return (
    <div>
      ...
      <div className="container">
            ...
            <div className="form_authentication col-12">
              ...
              <div className="form_auth2">                
                <div className="fields_fm">
                  ...
                  <input type="text" name="firstname" onChange={(e)=>{setfname(e.target.value)}} onKeyUp={validatefname} placeholder="Enter Your First Name Name"/>
                  <span className='errormessg'>{fnameError}</span>
                </div>
                <div className="fields_fm">
                  <label>Last Name</label>
                  <input type="text" name="lastname" onChange={(e)=>{setlname(e.target.value)}} onKeyUp={validatelname} placeholder="Enter Your Last Name"/>
                  <span className='errormessg'>{lnameError}</span>
                </div>
                <div className="fields_fm">
          ...
          <input type="number" className="form-control" onChange={(e)=>{setnumber(e.target.value)}} id="usermobile" placeholder="Enter Your Mobile Number" name="cust_mobile_number" style={{textAlign: "left",paddingLeft: "135px"}} required="" aria-required="true"/>
          <select className="form-control select2 col-md-3 select2-hidden-accessible" onChange={(e)=>{setcntCode(e.target.value)}} style={{marginTop: "-33px"}} name="cust_mobile_code" id="mobCode" required="" data-select2-id="mobCode" tabIndex="-1" aria-hidden="true" aria-required="true">
                      ...
                      <span className="select2 select2-container select2-container--default select2-container--focus" dir="ltr" data-select2-id="1" style={{width: "89px"}}>
                                    <span className="selection">
                                      <span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="0" aria-labelledby="select2-mobCode-container">
                                          <span className="select2-selection__rendered" id="select2-mobCode-container" role="textbox" aria-readonly="true" title="+974&nbsp;(QAT)">+974&nbsp;(QAT)</span>
          ...
          <span role="alert" style={{color:"green",display:"none",fontSize: "13px"}} id="usermob">
            Email accepted
                ...
                <div className="fields_fm">
                  ...
                  <input type="password" name="password" onKeyUp={(e)=>{setPassword(e.target.value)}} onChange={validatePassword} placeholder="Enter Your Password"/>
                  <span className='errormessg'>{lengthError}</span>
                </div>
                <div className="fields_fm">
                  <label>Confirm Password</label>
                  <input type="password" name="confirmpassword" onKeyUp={(e)=>{setcnfpassword(e.target.value)}} onChange={validateconfirmPassword} placeholder="Enter Your  Password"/>
